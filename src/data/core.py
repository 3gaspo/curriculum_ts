...
class SamplerConfig:
    ...
    # Optional probabilities aligned with local individual indices. Subsetting
    # selects and renormalizes the corresponding entries.
    individual_weights: Optional[List[float]] = None
    stride: int = 1
